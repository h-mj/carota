      ...
      inputs: {
        ...
        pieceQuantity: {
          ...
          reasons: {
            ...
            greater: "Пожалуйста, введите количество одной штуки больше чем 0.",
        ...
        quantity: {
          ...
          reasons: {
            ...
            greater: "Пожалуйста, введите количество больше чем 0.",
        ...
        unit: {
          label: "Единица",
          reasons: {
            string: "Пожалуйста, выберите единицу."
          }
        }
      },
      nutrients: {
    ...
    Register: {
      inputs: {
        ...
        language: {
          ...
          reasons: {
            string: "Пожалуйста, выберите язык."
          }
        },
        name: {
          label: "Имя",
        ...
        password: {
          ...
          reasons: {
            nonempty: "Пожалуйста, введите пароль.",
            greater: "Пароль должен содержать не менее 8 символов."
          }
        },
        sex: {
          label: "Пол",
          ...
          reasons: {
            string: "Пожалуйста, выберите свой пол."
          }
        }
      },
